...
{
    public class MockedIntegrationTestBase : IClassFixture<WebApplicationFactory<Program>>
    {
        ...
        public MockedIntegrationTestBase(WebApplicationFactory<Program> factory)
        {
